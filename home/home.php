...
<body>
    ...
    <div class="content">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <li class="nav-item">
                        ...
                        <?php if (isset($_SESSION['nickname'])): ?>
                            ...
                            <li class="nav-item">
                                <span class="nav-link" style="color: var(--brand_color);">
            ...
            <div class="row">
                <div class="col">
                    <div class="card" style="width: 30rem; background-color: var(--object_color);">
                        <img src="../assets/valogo.webp" class="card-img-top" alt="valLogo">
                        <div class="card-body">
                ...
                <div class="col">
                    <div class="card" style="width: 30rem; background-color: var(--object_color);">
                        <img src="../assets/lollogo.webp" class="card-img-top" alt="valLogo">
                        <div class="card-body">
                            <div class="d-flex justify-content-center">
        ...
        <div
            style="background-color: var(--transparent_col); height: auto;">
